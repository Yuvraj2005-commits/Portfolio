...
const experiences = [
  {
    ...
    status: "completed",
    description:
      "Developed backend modules and RESTful APIs using Node.js and Express.js for full-stack web applications. Designed MongoDB schemas and optimized database queries for efficient data retrieval, and integrated authentication, routing, and business logic components within scalable backend services — collaborating in an Agile environment with Git-based version control workflows.",
    highlights: [
      "Backend modules & REST APIs",
